...
Image-level Visual Adherence Critic v1 is implemented as a manifest-driven, actual-image reporting seam. It covers Tier-1 character, pose, background, and palette fields plus hand/foot anatomy labels, persists to session artifacts/replay, and does not repair, regenerate, or score similarity. Human acceptance of generated-image adherence remains a separate task.
